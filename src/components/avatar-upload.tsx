    ...
    <div className="flex flex-col items-center">
      <div className="relative inline-block">
        ...
        <button
          ...
          className="absolute bottom-1 right-1 flex size-8 items-center justify-center rounded-full border border-border bg-elevated text-text-secondary transition hover:bg-surface hover:text-text-primary"
